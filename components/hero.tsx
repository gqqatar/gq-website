  ...
  return (
    <section id="top" className="relative flex min-h-[100svh] items-end overflow-hidden bg-navy">
      <Image
        ...
        alt="A German Quality UPVC window installation on a Doha villa"
        fill
        priority
        sizes="100vw"
      ...
      <div className="relative z-10 mx-auto w-full max-w-7xl px-6 pb-20 pt-40 md:px-10 md:pb-28">
        ...
        <h1
          className="animate-fade-up mt-5 max-w-3xl font-display text-5xl font-medium leading-[1.05] text-white sm:text-6xl md:text-7xl"
          style={{ animationDelay: "0.08s" }}
        >
          Windows &amp; doors built to outlast the summer they were installed in.
        </h1>
        <p
          className="animate-fade-up mt-6 max-w-xl text-lg text-white/75"
          style={{ animationDelay: "0.16s" }}
        >
          Extra-thick German and Turkish UPVC profiles, Qatari-made aluminium, and
          precision installation &mdash; trusted on over 5,000 projects across Doha,
          Lusail, Al Wakra, and beyond since 2010.
        </p>
